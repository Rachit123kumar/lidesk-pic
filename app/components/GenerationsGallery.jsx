...
function CoinInfo({ generation }) {
  const transactions = generation.coinTransactions ?? [];
  ...
  return (
    <div className="flex items-center gap-2">
      {deduction && (
        <div
          title={deduction.description || "Coins consumed"}
          className="inline-flex items-center gap-1 px-2 py-1 rounded-md bg-white/[0.04] border border-white/5"
        >
      ...
      {credit && (
        <div
          title={credit.description || "Coins refunded"}
          className="inline-flex items-center gap-1 px-2 py-1 rounded-md bg-emerald-400/10 border border-emerald-400/10"
        >
          ...
          {generations.map((generation, i) => {
            ...
            return (
              ...
              >
                ...
                <CoinInfo generation={generation} />

                <span
                  className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-md text-xs font-medium capitalize ${s.text} ${s.bg} flex-shrink-0`}
                >
                  <span
                    className={`w-1.5 h-1.5 rounded-full ${s.dot} ${
                      generation.status === "processing" ||
              ...
              >
                ...
                <div className="flex items-center justify-between gap-2 px-3.5 py-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-md text-xs font-medium capitalize ${s.text} ${s.bg}`}
                    >
                      <span
                        className={`w-1.5 h-1.5 rounded-full ${s.dot}`}
                      />
